...
<div class="bg-gray-800">
	<div class="container xl:max-w-7xl mx-auto p-4 lg:p-8">
		...
		>
			<div class="grow">
				<h1 class="text-xl font-bold text-gray-700 mb-1">Dashboard</h1>
				<h2 class="text-sm text-gray-500 font-medium">
					Welcome <a href="javascript:void(0)" class="text-indigo-600 hover:text-indigo-400">John</a
			...
			>
				...
				>
					<svg
						...
						class="opacity-50 hi-solid hi-plus inline-block w-5 h-5"
						><path
							fill-rule="evenodd"
