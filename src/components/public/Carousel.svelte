	...
	<div class="flex flex-wrap justify-between items-center">
		...
		<div class="w-full lg:w-12/12 mt-4">
			<div id="default-carousel" data-carousel="slide" class="relative">
				<div class="overflow-hidden relative h-[50vh]">
					<div
						class="1200 ease-in-out absolute inset-0 transition-all transform translate-x-0"
						data-carousel-item="active"
					>
						<img
							src="/slider/shipping-1.jpg"
					...
					<div
						class="1200 ease-in-out absolute inset-0 transition-all transform translate-x-full"
						data-carousel-item=""
					>
						<img
							src="/slider/storage-1.jpg"
							class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
							alt="..."
						/>
					</div>
					...
					<div
						class="hidden 1200 ease-in-out absolute inset-0 transition-all transform"
						data-carousel-item=""
					>
						<img
							src="/slider/packages-1.jpg"
							class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
							alt="..."
						/>
					</div>
