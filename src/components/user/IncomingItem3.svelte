	...
	<div class="mt-4">
		<dl>
			<div class="bg-white p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				...
				<dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{pkg[2].dateUploaded}</dd>
			</div>
			<div class="bg-slate-50 p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				<dt class="text-xs tracking-tight uppercase font-medium text-slate-600 truncate">
					Invoice #:
				</dt>
				<dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{pkg[2].invoice}</dd>
			</div>
			<div class="bg-white p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				<dt class="text-xs tracking-tight uppercase font-medium text-slate-600 truncate">
					Supplier:
				</dt>
				<dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{pkg[2].supplier}</dd>
			</div>
			<div class="bg-slate-50 p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				<dt class="text-xs tracking-tight uppercase font-medium text-slate-600 truncate">
					Tracking Number:
			...
			<div class="bg-slate-50 p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				...
				<dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{pkg[2].invoicePreview}</dd>
			</div>
			<div class="bg-white p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				<dt class="text-xs tracking-tight uppercase font-medium text-slate-600 truncate">
					Package Notes:
				</dt>
				<dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{pkg[2].packageNotes}</dd>
			</div>
			<div class="bg-slate-50 p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				<dt class="text-xs tracking-tight uppercase font-medium text-slate-600 truncate">
					Status:
				</dt>
				<dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{pkg[2].status}</dd>
			</div>
			<div class="bg-white p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				<dt class="text-xs tracking-tight uppercase font-medium text-slate-600 truncate">
					Arrival Date:
				</dt>
				<dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{pkg[2].arrivalDate}</dd>
			</div>
			<div class="bg-slate-50 p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				<dt class="text-xs tracking-tight uppercase font-medium text-slate-600 truncate">
					Arrival Time:
				</dt>
				<dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{pkg[2].arrivalTime}</dd>
			</div>
			<div class="bg-white p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				<dt class="text-xs tracking-tight uppercase font-medium text-slate-600 truncate">
					Images:
